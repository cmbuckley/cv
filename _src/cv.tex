...
An accomplished technology leader with over \ExperienceYears{2008} years' experience
building and maintaining scalable digital platforms. Experienced in shaping technical strategy,
leading engineering squads and building high-quality production systems in modern Web stacks.
Combines extensive hands-on engineering experience with strong architectural leadership and team
mentorship, specialising in API-first architectures and event-driven systems, working with legacy
and modern estates in on-premises and cloud environments across financial services, retail and
iGaming sectors. Known for creating a culture of collaboration, continuous learning and ownership,
effectively communicating with clients and aligning stakeholders at all organisational levels.
...
\item Engineering standards \& Developer Experience
\item Agile development methodologies (Scrum, Kanban)
\end{itemize}
\end{multicols}
...
\item Responsible for engineering maturity roadmap delivering best practices in AI-enabled
      software development, quality assurance \& continuous integration using DORA metrics
...
\item Responsible for technology forecasting, career progression framework, coaching \&
...
\item Technical Architect for Platform Engineering team responsible for on-premises Kubernetes cluster,
      internal CI pipelines, tooling, Infrastructure as Code, Developer Experience \& DevOps/SRE practices
\item Designed \& launched a real-time Kafka data streaming platform enabling event-driven integration with Data teams
...
\item Technical lead for Sky Poker development team, delivering high-traffic Web services using
      Zend Framework \& modular JavaScript
\item Led development \& maintenance of a JavaScript poker application integrating with existing
