...
\item Technical appraisal \& decomposition of existing technology platforms, services \& suppliers
...
\item Pioneered use of Kafka to standardise event-driven integration strategy with Data teams
...
\item Built \& maintained a JavaScript poker application integrating with existing third-party engine \& API
...
\item Responsible for API contract design, integration patterns \& development of standards for REST/SOAP services
