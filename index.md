...
description: An accomplished technology leader and mentor with over 18 years' experience building and evolving large-scale platforms and leading high-performing teams.
og_type: profile
class: cv
style:
  - /assets/cv.css
...
* Led and scaled 15-person engineering team in a regulated B2B SaaS environment serving 7000+ clients, building a culture of accountability, collaboration & operational excellence
* Assessed team capability & structure, identifying gaps in technical depth and defining hiring & training priorities
* Established clear ownership boundaries across 4 Agile squads, improving delivery predictability
* Responsible for engineering maturity roadmap delivering best practices in software development, quality assurance & continuous integration using DORA & SPACE metrics frameworks
* Partnered with Product leadership to ensure effective planning & execution of product roadmap
* Responsible for technology budgets, forecasting, career progression framework, coaching & mentoring, strategic client/vendor relationships
...
* Defined technical strategy for architecture & engineering capabilities, client engagement & account management with clients across healthcare, financial services & retail sectors
...
* Promoted adoption of DevOps practices, Terraform & management of AWS Partner programme
...
* Overall responsibility for technology within Preventx, including the platform, infrastructure, operations & quality management
...
* Delivered organisation digital modernisation & maturity improvements for SDLC, software governance, continuous integration & ways of working

#### Principal Architect, Strike
* Architecture lead for Strike during acquisition of Purplebricks
* Technical appraisal of existing technology platforms, services & suppliers
* Defined target operating model, consolidated target architecture, change roadmap & risk assessment, enabling accelerated re-launch under a single brand & proposition within 6 months
...
* Responsible for architecture principles & Technical Design Authority to oversee programme change
...
* Technical Architect for Platform Engineering team responsible for on-premises Kubernetes cluster, internal tooling, Infrastructure as Code, Developer Experience & SRE practices
* Pioneered use of Kafka to standardise real-time event-driven architecture with Data teams
...
* Incident Commander providing measured support to on-call teams during incidents & major events
* Technical contact for third-party suppliers providing supporting services and delivery capability
* Mentor & coach to other architects & engineers in teams across gaming products & services
...
* Evolved & communicated SDLC, increasing deployment frequency from 10 to over 200 per week
...
* Technical lead for Sky Poker LAMP development team using Zend Framework & modular JavaScript
* Built & maintained a JavaScript poker application integrating with existing third-party engine
* Technical liaison for third-party supplier integration and overall software architecture
...
* Delivered multi-channel customer satisfaction survey platform using Zend Framework & ActiveMQ, enabling real-time customer feedback
* Established Agile delivery practices (Scrum, XP, Kanban) & supported organisation in Agile adoption
* Maintained Jenkins continuous integration platform and code analysis tools
* Design authority and development of standards for RESTful Web services
* Supported team recruitment process conducting interviews & technical tests
